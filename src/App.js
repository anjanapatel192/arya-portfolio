    ...
    <div style={{ background: BG, minHeight: "100vh", color: "#e2e8f0", fontFamily: "'Inter', sans-serif", position: "relative", overflowX: "hidden" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .nav-links.open { display: flex !important; flex-direction: column; position: fixed; top: 60px; left: 0; right: 0; background: #050c15ee; padding: 24px; gap: 16px; backdrop-filter: blur(20px); z-index: 100; }
      ...
      <section id="home" style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "100px 5% 60px", position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", animation: "fadeUp 1s ease both" }}>
          ...
          <div style={{
            fontFamily: "'DM Mono', monospace", fontSize: "clamp(14px, 2vw, 18px)",
            color: "#64748b", marginBottom: 36, height: 28,
          }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            ...
            <button onClick={() => scrollTo("contact")} style={{
              ...
              onMouseLeave={e => { e.target.style.borderColor = BORDER; e.target.style.color = "#94a3b8"; }}
            >GET IN TOUCH</button>
            <button onClick={downloadResume} style={{
              padding: "14px 32px", borderRadius: 6,
        ...
        <div style={{
          ...
          {["Node.js", "AWS", "Kafka", "Redis", "Socket.IO"].map((t, i) => (
            <div key={t} style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="grid-2">
            <div>
              ...
              <div style={{ marginTop: 32, display: "flex", gap: 16 }}>
                <a href="mailto:aryapatel2403@gmail.com" style={{
